...
let staffUpdateBtn = document.querySelector('.staff-update-btn');
let staffUpdateIcon = document.querySelector('.staff-update-icon');
let formUpdateStaff = document.querySelector('.staff-update-contain');

staffUpdateBtn.onclick = () => {
    formUpdateStaff.style.display = 'flex';
};

staffUpdateIcon.onclick = () => {
    formUpdateStaff.style.display = 'none';
};